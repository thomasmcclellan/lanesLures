...
import { Image, ContentService } from '../services/content.service';
...
export class AdminComponent implements OnInit {
  ...
  constructor(private dataStorageService: DataStorageService,public router: Router, private contentService: ContentService ) {
    this.getContent();
